  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className={`text-center space-y-8 p-6 md:p-12 backdrop-blur-lg bg-white/5 rounded-3xl border border-white/10 
                    transform transition-all duration-1000 hover:scale-[1.02] w-full max-w-4xl relative
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="relative px-8 md:px-12">
            <Sparkles className="absolute -top-8 -left-0 w-6 h-6 text-yellow-300/70 animate-pulse" />
            <Star className="absolute -top-4 right-0 w-6 h-6 text-purple-300/70 animate-bounce" />
            <Heart className="absolute -bottom-4 right-0 w-6 h-6 text-pink-300/70 animate-pulse" />
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold bg-clip-text text-transparent 
                       ...
                       animate-text-gradient break-words">
              Dhruvinkumar Patel
            </h1>
          </div>
        </div>
